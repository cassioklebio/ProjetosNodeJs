...
routerUsuario.post("/usuario/registro", (req, res)=>{
    var erros = []
    ...
    if(erros.length > 0){
        ...
        Usuario.findOne({email: req.body.email}).then((usuario)=>{
            if(usuario){
                req.flash("error_msg", "Já exite um conta com este e-mail no sistema")
...
routerUsuario.post("/usuario/login", (req, res, next)=>{
